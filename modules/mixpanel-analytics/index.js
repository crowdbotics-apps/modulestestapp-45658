...
import { Text, View, ScrollView, Switch, TouchableOpacity, SafeAreaView } from "react-native";
...
const App = () => {
  ...
  const getTrackingStatus = () => {
    mixpanel.hasOptedOutTracking().then(res => {
      setIsEnabled(res);
  ...
  const setUserProfile = () => {
    mixpanel.getPeople().set({
      ...
      $phone: "1223456789",
      $avatar: "https://images.unsplash.com/photo-1495344517868-8ebaf0a2044a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8fA%3D%3D&w=1000&q=80",
      $city: "NYC",
  ...
  const trackEventsWithGroups = () => {
    mixpanel.trackWithGroups("Purchase", {
      Amount: 100
  ...
  return <SafeAreaView style={styles.container}>
      ...
      <View style={styles.switchView}>
        ...
        false: "#767577",
        true: "#000"
      }} thumbColor={isEnabled ? "#fff" : "#fff"} ios_backgroundColor="#3e3e3e" onValueChange={toggleTracking} value={!isEnabled} />
      </View>

      <ScrollView style={_styles.imTkHzmQ}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.buttonStyles} onPress={setUserProfile}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={styles.buttonStyles} onPress={trackEventsWithGroups}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.buttonStyles} onPress={addSuperProperties}>
